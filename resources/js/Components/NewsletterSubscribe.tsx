  ...
  return (
    <section id={sectionId} className={`scroll-mt-24 px-4 py-12 sm:px-8 sm:py-16 lg:p-16 ${className}`}>
      <div className="relative overflow-hidden rounded-2xl max-w-7xl mx-auto py-16 px-6 sm:py-20 sm:px-10 lg:py-24 lg:px-16">
        ...
        <div className="relative backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 sm:p-10 lg:p-12 text-center max-w-2xl mx-auto">
          {displayBadge && (
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-4 sm:mb-6 tracking-tight leading-tight">
            {displayHeading}
          </h2>
              ...
              <div className="flex flex-col gap-3">
                <div>
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-md bg-white/10 border border-white/20 text-white placeholder-white/50 focus:border-white/40 focus:ring-1 focus:ring-white/40 outline-none text-sm backdrop-blur-sm"
                  />
                  {errors.email && (
                    <p className="text-red-300 text-sm mt-2 text-start">{errors.email}</p>
                  )}
                </div>
                <div>
                  <input
                  ...
                  />
                  {errors.phone && (
                    <p className="text-red-300 text-sm mt-2 text-start">{errors.phone}</p>
                  )}
                </div>
                <button
                  type="submit"
