      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-3 bg-surface rounded-lg p-8 md:p-12 flex flex-col md:flex-row gap-10 items-center">
             ...
             <div className="flex-1 text-center md:text-start">
                ...
                <div className="flex gap-4 justify-center md:justify-start">
                   <button className="p-2 rounded-md bg-white hover:bg-gray-100 transition-colors text-gray-600">
          ...
          <div className="bg-gray-50 rounded-lg p-8 hover:bg-white transition-all duration-300 border border-gray-100 group">
             <div className="w-20 h-20 rounded-md overflow-hidden mb-6 group-hover:scale-105 transition-transform">
                <img
                  src="/assets/images/team-acceleration.jpg"
          ...
          <div className="bg-gray-50 rounded-lg p-8 hover:bg-white transition-all duration-300 border border-gray-100 group">
             <div className="w-20 h-20 rounded-md overflow-hidden mb-6 group-hover:scale-105 transition-transform">
                <img
                  src="/assets/images/team-venture-building.jpg"
