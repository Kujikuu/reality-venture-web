...
<head>
    ...
    <style>
        body { font-family: dejavusans; font-size: 12pt; color: #1a1a1a; line-height: 1.6; }
        h1 { font-size: 20pt; color: #062D2D; margin-bottom: 4px; }
        h2 { font-size: 14pt; color: #062D2D; margin-top: 20px; margin-bottom: 8px; }
        ...
        .signature-label { font-size: 10pt; text-transform: uppercase; color: #888; letter-spacing: 0.05em; }
        .signature-value { font-size: 16pt; font-weight: bold; margin-top: 4px; }
        hr { border: 0; border-top: 1px solid #e5e5e5; margin: 28px 0; }
        .english { direction: ltr; text-align: left; }
        .arabic { direction: rtl; text-align: right; font-family: xbriyaz; }
    </style>
</head>
<body>
    <div class="english">
