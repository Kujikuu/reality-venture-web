...
class BrandColorTokenTest extends TestCase
{
    public function test_brand_color_tokens_are_updated_across_active_surfaces(): void
    {
        $files = [
            ...
            resource_path('views/components/mail/reference.blade.php'),
            resource_path('views/components/mail/heading.blade.php'),
            resource_path('views/components/mail/cta-button.blade.php'),
            resource_path('views/emails/applications/demo-day-invitation.blade.php'),
            resource_path('views/emails/applications/general-confirmation.blade.php'),
            resource_path('views/emails/applications/new-application-submitted.blade.php'),
            resource_path('views/emails/applications/stage-applying.blade.php'),
            resource_path('views/emails/applications/stage-decision.blade.php'),
            resource_path('views/emails/applications/stage-evaluation.blade.php'),
            resource_path('views/emails/applications/startup-confirmation.blade.php'),
            resource_path('views/emails/applications/welcome-to-club.blade.php'),
        ];
